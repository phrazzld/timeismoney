 ...
 */
export function showError(status: HTMLElement, message: string, timeout: number = 2000): boolean {
 ...
 */
export function validateCurrencySymbol(symbol: string, status: HTMLElement): boolean {
 ...
 * @returns {boolean} True if valid, false otherwise
 */
export function validateCurrencyCode(code: string, status: HTMLElement): boolean {
 ...
 * @returns {boolean} True if valid, false otherwise
 */
export function validateDebounceInterval(intervalStr: string, status: HTMLElement): boolean {
