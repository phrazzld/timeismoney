/**
 * Example refactored integration test for storage.ts
...
import { setupChromeMocks, resetAllMocks } from '../setup-mocks.js';
 ...
 * 1. Using centralized Chrome API mocks imported from chrome-api.mock.ts
 * 2. Using setup/teardown helpers from setup-mocks.ts
