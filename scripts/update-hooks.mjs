 ...
 * 
 * Usage:
 * node scripts/update-hooks.mjs <file_path>
 */
...
const describeMatch = modifiedContent.match(/describe\s*\(\s*['"`](.+?)['"`]\s*,\s*\(\s*\)\s*=>\s*\{/);
